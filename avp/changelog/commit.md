...
## v2.0.3 (2026-02-18)
- FIX: re-normalize external changelog formatting (multiline) and preserve legacy history
- CHG: govern avp/changelog/*.md + changelog_guard (INDEX vs HEAD) to prevent truncation
